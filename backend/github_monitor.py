...
GRAPH_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "codebase_graph.json")
...
def update_knowledge_graph(repo_full_name, commit_sha, modified_files, dependencies,
    ...
    # FIX: Unconditionally link the commit to EVERY file it modified
    ...
    # Then map the downstream module dependencies
